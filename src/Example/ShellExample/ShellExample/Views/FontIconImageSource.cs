...
internal class FontIconImageSource : DrawingImage
{
    public static readonly StyledProperty<string> ValueProperty =
        AvaloniaProperty.Register<FontIconImageSource, string>(nameof(Value));

    public static readonly StyledProperty<IBrush?> BrushProperty =
        AvaloniaProperty.Register<FontIconImageSource, IBrush?>(nameof(Brush));

    public static readonly StyledProperty<IPen?> PenProperty =
        AvaloniaProperty.Register<FontIconImageSource, IPen?>(nameof(Pen));
